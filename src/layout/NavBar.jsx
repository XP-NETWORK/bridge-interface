        ...
        <Navbar expand="lg">
          ...
          <Navbar.Collapse id="" style={{ marginLeft: "10px" }}>
            <Nav>
              ...
              {from && to && account && (
                <div className={"destination__address pb-2"}>
                  <button
              ...
              <a
                ...
                onClick={() => handleEventsForAnalytics("Help Center")}
              >
                <div className="nav-link__icon">
                  <img src={message} alt="" />
                </div>
              ...
              <Nav.Link
                ...
                onClick={() => handleEventsForAnalytics("Bridge Security")}
              >
                <div className="nav-link__icon">
              ...
              <Nav.Link
                ...
                onClick={() => handleEventsForAnalytics("Github")}
              >
                <div className="nav-link__icon">
                  <img src={github} alt="" />
                </div>
              ...
              <Nav.Link
                ...
                href="#"
                onClick={() => {
                  handleEventsForAnalytics("NavBar Video Tutorial");
                ...
                <Dropdown.Menu>
                  <div onClick={() => toggleNavMenu(false)}>
                    ...
                    >
                      <div
                        onClick={() =>
                          handleEventsForAnalytics("Burger Github")
                        }
                        className="drop-item"
                      >
                        <img src={github} alt="" />
                    ...
                    >
                      <div
                        onClick={() =>
                          handleEventsForAnalytics("Burger Bridge Security")
                        }
                        className="drop-item"
                      >
                        <img src={security} alt="" />
                    ...
                    >
                      <div
                        onClick={() => handleEventsForAnalytics("Burger FAQ")}
                        className="drop-item"
                      >
                        <img src={faq} alt="" />
                    ...
                    >
                      <div
                        onClick={() => handleEventsForAnalytics("Burger docs")}
                        className="drop-item"
                      >
                        <img src={docs} alt="" />
                    ...
                    <Dropdown.Item onClick={() => dispatch(setShowVideo(true))}>
                      <div
                        onClick={() =>
                          handleEventsForAnalytics("Burger tutorial")
                        }
                        className="drop-item"
                      >
                        <img src={video} alt="" />
                    ...
                    <Dropdown.Item href="https://xp.network/" target="_blank">
                      <div
                        onClick={() =>
                          handleEventsForAnalytics("Burger website")
                        }
                        className="drop-item"
                      >
                        <img src={xpnet} alt="" />
                    ...
                    >
                      <div
                        onClick={() =>
                          handleEventsForAnalytics("Burger Help Center")
                        }
                        className="drop-item"
                      >
                        <img src={message} alt="" />
