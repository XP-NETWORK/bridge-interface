...
export const RightSide = ({ setChoosenChain, choosenChain, bridge }) => {
    ...
    return (
        <>
            <div className="right-side">
                ...
                <div className="xp-crossroads line-down-margin">
                    XP Crossroads
                </div>
                ...
                <div className="multichain-bridge-nft-line line-down-margin-24">
                    A unique multi-chain NFT collection that celebrates the
                    bridging campaign between XP.NETWORK and Aurora.
                </div>
                <ChainSelect
