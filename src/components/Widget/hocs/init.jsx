    ...
    return function CB() {
        ...
        useEffect(() => {
            if (searchparams) {
                ...
                return () =>
                    window.removeEventListener("message", parentAccountChange);
            }
        }, [searchparams]);
                    ...
                    dispatch(
                        setSettings({
                            ...
                            affiliationFees: affiliationFees
                                ...
                                : 0,
                            affiliationSettings: affiliationSettings?.map(
                                (feeSetting) => ({
                                    ...feeSetting,
                                    chain:
                                        feeSetting.chain === "Gnosis"
                                            ? "xDai"
                                            : feeSetting.chain,
                                    extraFees: feeSetting.extraFees
                                        ? (
                                              (+feeSetting.extraFees - 1) *
                                              100
                                          ).toFixed(1)
                                        : 0,
                                })
