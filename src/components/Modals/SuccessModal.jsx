            ...
            <Modal.Body className="success-info-list">
                            ...
                            <div className="info-item-label">Txn Hash</div>
                                <CopyToClipboard text={getTX() || "No tx"}>   
                                    <div className='success-hash'>
                                        ...
                                        <Image src={copyHover ? CopyHover : FileCopy} className="success__copy" />
                                    </div>
                                </CopyToClipboard>
                        </div>
                    </div>
                    <div className="success-info-box">
                        ...
                        <div className="success-info-item">
                            ...
                            <div className="success-hash">{address ?`${address.substring(0, getSubstringValue() || 10)}...${address.substring(address.length - 6)}`:''}</div>
                        </div>
                        <div className="success-info-item">
                        ...
                        <div className="success-info-item">
                            ...
                            <div className="success-hash">{receiver ?`${receiver.substring(0, getSubstringValue() || 10)}...${receiver.substring(receiver.length - 6)}`:'test'}</div>
                        </div>
                    </div>
                    <div className="success-info-box">
