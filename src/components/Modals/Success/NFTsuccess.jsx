                                    ...
                                    <div className="txn-hash">
                                        ...
                                        {widget ? (
                                            <FileCopyComp
                                                onClick={() => copy()}
                                                onMouseOver={() =>
                                                    setSetCopyHover(true)
                                                }
                                                onMouseOut={() =>
                                                    setSetCopyHover(false)
                                                }
                        ...
                        <div className="nftSelectList">
                            <div className="nftSeleTop">
                                <div className="selectedNft">
                                    Sent NFT{" "}
                                    <span>{`/ ${selectedNFTList?.length}`}</span>
                                </div>
                            </div>
...
function SuccessNFT({ nft, from, index }) {
    ...
    return (
        <li className="nftSelecItem">
            ...
            <span className="nftSelected__name">
