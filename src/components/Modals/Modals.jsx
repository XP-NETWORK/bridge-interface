...
import SwitchToV4Modal from "./SwitchToV4Modal/SwitchToV4Modal";
...
export default function Modals() {
  ...
  const showSwitchToV4Modal = useSelector(
    (state) => state.general.showSwitchToV4Modal,
  );
  ...
  const WalletConnectModal = useMemo(
    () =>
      withWalletConnect(({ walletConnectClient }) => {
        ...
        return (
          walletConnectClient && (
            <Web3Modal projectId={wcId} ethereumClient={walletConnectClient} />
          )
        );
      }),
    [],
