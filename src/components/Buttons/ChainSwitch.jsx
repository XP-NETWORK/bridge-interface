...
import { setChainModal, setDepartureOrDestination, setSwitchDestination } from '../../store/reducers/generalSlice'
import "./Buttons.css"
...
export default function ChainSwitch({ assignment, func }) {
    ...
    const show = () => {
        switch (assignment) {
            case "from":
            return(
            <span style={walletconnect || nonEVM? OFF : {}} onClick={handleFromChainSwitch} className='chain-switch'>
