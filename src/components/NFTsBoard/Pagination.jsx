...
export default function Pagination() {
  ...
  const filteredNFTList = useSelector((state) => state.general.filteredNFTList);
  ...
  const nfts = NFTListSearch || originalNFTList;
  ...
  }, [selectedPage, originalNFTList, NFTListSearch]);
