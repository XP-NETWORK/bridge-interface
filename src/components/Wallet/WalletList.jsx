...
export default function WalletList({ search, connected, input }) {
    ...
    const walletComponents = [
        ...
        {
            Component: <TronWallet key="wallet-index-11" close={connected} />,
            name: "TronLink",
            type: "Tron",
            mobile: true,
            desktop: true,
        ...
        {
            Component: (
                <VeChainWallet key="wallet-index-12" close={connected} />
            ),
            name: "Sync2",
            type: "VeChain",
            mobile: true,
        ...
        {
            Component: <USBWallet key="wallet-index14" connected={connected} />,
            name: "Trezor",
            mobile: false,
            desktop: true,
        },
