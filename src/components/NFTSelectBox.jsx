        ...
        <div className="selChain seleDepat" onClick={() => handleShow("departure")}>
            { from ? 
                <div className="seleDepatSelec">
                    <img  style={{width: "30px"}} src={ from.image.src } alt="" />{from.text}
                </div>
                :
                <div className="seleDepatSelec">
                    <img  style={{width: "30px"}} src={ Departure } alt="" />Select departure chain
                </div>
            }
        </div>
        { from && to ?
        ...
        <div className="selChain seleDesti" onClick={() => handleShow("destination")}>
            { to ?
                <div className="seleDestiSele">
                    <img  style={{width: "30px"}} src={ to.image.src } alt="" />{to.text}
                </div>
                :
                <div className="seleDestiSele">
                    <img  style={{width: "30px"}} src={ Destination } alt="" />Select destination chain
                </div>
            }
        </div>
</div>
