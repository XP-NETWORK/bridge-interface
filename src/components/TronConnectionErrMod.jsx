...
export default function TronConnectionErrMod() {
    ...
    return ( error === "noTronWeb" ?
        <Modal className="ts-modal" animation={false} size="sm" show={error} onHide={() => handleClose()}>
            <Modal.Header className="border-0">
                
                <span className="close-ts-modal" onClick={() => handleClose()}>
                    <img src={Close} alt="" />
                </span>
                <Modal.Title className='tron-error-title'>TronLink extension is not installed on your browser</Modal.Title>
            </Modal.Header>
        ...
        <Modal className="ts-modal" animation={false} size="sm" show={error} onHide={() => handleClose()}>
            <Modal.Header className="border-0">
                ...
                <Modal.Title className='tron-error-title'>TronLink extension is not connected on your browser</Modal.Title>
                <Modal.Body>
                </Modal.Body>
            </Modal.Header>
        </Modal>
