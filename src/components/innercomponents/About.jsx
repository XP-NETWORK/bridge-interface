        ...
        <Modal show={show} onHide={() => handleClose()}>
            ...
            <Modal.Body>
                <div style={{color: "white"}}  className="about__text">
                    ...
                    university diplomas, professional licenses and permits, insurance contracts, and much more.</p>
                    <p>NFTs are gradually becoming the key component of the digital economies used as assets for trading or investment. 
                    The price of an NFT gets higher if art connoisseurs or collectors recognize the artistic, historical, 
                    or gaming ecosystem value in the asset it represents.</p>
                </div>
            </Modal.Body>
        </Modal>
    )
